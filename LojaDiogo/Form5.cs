...
namespace LojaDiogo
{
    public partial class Form5 : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nao existe nenhuma categoria selecionada.", "Aviso", 
        ...
        private void btnAtualizar_Click(object sender, EventArgs e)
        {
            if(posLista != -1)
            {
                ...
                dataGridView1.Rows.RemoveAt(posLista);
                dataGridView1.Rows.Insert(posLista, txtCodigo.Text, txtCategoria.Text, txtZona.Text, txtFila.Text, txtParteleira.Text);
                posLista = -1;
                Limpar();
            }
        }
